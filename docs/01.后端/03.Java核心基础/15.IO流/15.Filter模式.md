---
title: Filter模式
date: 2021-01-07 19:32:54
permalink: /pages/d446b1/
categories:
  - 后端
  - Java核心基础
  - IO流
...
上述这种**通过一个“基础”组件再叠加各种“附加”功能组件的模式，称之为Filter模式（或者装饰器模式：Decorator）。**
