...
module.exports = {
  ...
  head: [
    ...
    [
      "meta",
      {
        ...
        content: "zLD7NpxIQqa3yimtkMOD-WYwUKyLypzWkXW2KWh3xEs",
      },
    ], // google统计的站点拥有者验证
  ...
  themeConfig: {
    ...
    repo: "SaulJWu/SaulJWu.github.io", // 导航栏右侧生成Github链接
    ...
    blogger: {
      // 博主信息，显示在首页侧边栏
      avatar:
        "https://gitee.com/SaulJWu/blog-images/raw/master/images/20210627222322.jpg",
      name: "Saul.J.Wu",
      slogan: "立身之本，不在高低。",
    },
    social: {
    ...
    footer: {
      ...
      copyrightInfo:
        'Saul.J.Wu | <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
    },
  },
  plugins: [
